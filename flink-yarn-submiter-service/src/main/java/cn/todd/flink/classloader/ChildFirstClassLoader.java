 ...
 * override that.
 */
public final class ChildFirstClassLoader extends AbsSubmitterClassLoader {
    static {
    ...
    public ChildFirstClassLoader(URL[] urls, ClassLoader parent) {
        this(urls, parent, new String[] {}, NOOP_EXCEPTION_HANDLER);
    }

    public ChildFirstClassLoader(
            URL[] urls, ClassLoader parent, String[] alwaysParentFirstPatterns) {
        this(urls, parent, alwaysParentFirstPatterns, NOOP_EXCEPTION_HANDLER);
    }
