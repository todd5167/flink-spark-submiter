...
package cn.todd.flink.connectors.randomdata.factory;

import cn.todd.flink.connectors.randomdata.source.RandomDataGenTableSource;
...
/**
 * reference {@link DataGenTableSource}
 */
public class RandomDataTableSourceFactory implements DynamicTableSourceFactory {
    public static final String IDENTIFIER = "randomdata";
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new RandomDataGenTableSource(
                fieldGenerators,
                name,
                schema,
