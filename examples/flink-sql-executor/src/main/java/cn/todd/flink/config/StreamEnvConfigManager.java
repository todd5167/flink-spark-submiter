...
public class StreamEnvConfigManager {
     ...
     */
    public static void streamExecutionEnvironmentConfig(StreamExecutionEnvironment streamEnv,
    ...
    public static Optional<Boolean> isCheckpointingEnabled(Properties properties) {
        boolean checkpointEnabled = properties.getProperty(FLINK_CHECKPOINT_INTERVAL_KEY) != null;
        return Optional.of(checkpointEnabled);
    }

    public static Optional<Boolean> enableUnalignedCheckpoints(Properties properties) {
        String unalignedCheckpoints = properties.getProperty(SQL_UNALIGNED_CHECKPOINTS);
    ...
    public static Optional<Long> getCheckpointInterval(Properties properties) {
        Long flinkCheckpointInterval = Long.valueOf(properties.getProperty(FLINK_CHECKPOINT_INTERVAL_KEY, "0"));
        return Optional.of(flinkCheckpointInterval);
    }

    public static Optional<CheckpointingMode> getCheckpointingMode(Properties properties) {
        String checkpointingModeStr = properties.getProperty(FLINK_CHECKPOINT_MODE_KEY);
    ...
    public static Optional<CheckpointConfig.ExternalizedCheckpointCleanup> getCheckpointCleanup(Properties properties) {
        Boolean sqlCleanMode = BooleanUtils.toBoolean(properties.getProperty(FLINK_CHECKPOINT_CLEANUPMODE_KEY, "false"));

        CheckpointConfig.ExternalizedCheckpointCleanup externalizedCheckpointCleanup = (sqlCleanMode) ?
